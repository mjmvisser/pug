...
TestCase {
    ...
    function test_seq() {
        ...
        compare(seq.elements[0].frames.length, 10);
    }
    ...
    function test_shotgunThumbnail() {
        ...
        verify(Util.exists(shotgunThumbnail.File.elements[0].path()));
    }
    ...
    function test_shotgunFilmstrip() {
        ...
        verify(Util.exists(shotgunFilmstrip.File.elements[0].path()));
    }
